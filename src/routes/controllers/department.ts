...
export class DepartmentController {
    ...
    private get(req: Request, res: Response) {
        ...
        this.findDepByPk(req.params.id).then((dep: db.Department) => {
    ...
    private create(req: Request, res: Response) {
        ...
        db.Department.create({
            ...
            const addWorkersPromise = req.body.Workers && req.body.Workers.length > 0 ? this.addWorkersPr(dep, req.body.Workers) : Promise.resolve(true);

            Promise.all([addParentDepPromise, addSubDepartmentsPromise, addWorkersPromise]).then(() => {
                this.findDepByPk(dep.id).then(dep => {
    ...
    private updateOne(req: Request, res: Response) {
        ...
        },
        {
            ...
            this.findDepByPk(req.body.id).then(dep => {
