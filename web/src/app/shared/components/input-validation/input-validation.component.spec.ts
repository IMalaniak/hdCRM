...
import { CONSTANTS, INPUT_ERROR } from '@/shared/constants';
...
describe('InputValidationComponent', () => {
  ...
  it('should set error message', fakeAsync(() => {
    ...
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.IS_REQUIRED);

    component.control.setValue('test');
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.IS_TOO_SHORT);

    component.control.setValue('testtesttesttest');
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.IS_TOO_LONG);
    ...
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.INVALID_EMAIL);
  }));
  ...
  it('should set error message with regex', fakeAsync(() => {
    ...
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.IS_INVALID);
  }));
  ...
  it('should set error with min and max value', fakeAsync(() => {
    ...
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.MIN_VALUE);

    component.control.setValue(20);
    fixture.detectChanges();
    tick();
    expect(component.child.errorMessage).toEqual(INPUT_ERROR.MAX_VALUE);
  }));
});
