...
export class DepartmentsComponent implements OnInit, AfterViewInit {
  ...
  canAddDepPrivilege$: Observable<boolean> = this.store.pipe(select(isPrivileged('department-add')));
  canEditDepPrivilege$: Observable<boolean> = this.store.pipe(select(isPrivileged('department-edit')));
  canDeleteDepPrivilege$: Observable<boolean> = this.store.pipe(select(isPrivileged('department-delete')));
